...
setup(name=name,
    ...
    packages=[
        ...
        'trytond.modules.contract_invoice_journal.tests',
        ],
    package_data={
        'trytond.modules.contract_invoice_journal': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    contract_invoice_journal = trytond.modules.contract_invoice_journal
    """,
    test_suite='tests',
